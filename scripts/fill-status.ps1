...
<#
.SYNOPSIS
    Show the state of the Scissors ASP Fill project: families, versions, support
...
.DESCRIPTION
    ...
    uses the defaults for the Scissors ASP project.
...
$Project = Cfg 'ProjectKey' 'scissors-asp'
